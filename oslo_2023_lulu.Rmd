...
its strengths and weaknesses. I would like to point out that
programming bugs are a **very** common thing, and that the presence of
a bug in `lulu` should not reflect badly on the work of Frøslev and
colleagues.
